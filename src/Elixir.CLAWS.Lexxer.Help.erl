...
-module('Elixir.CLAWS.Lexxer.Help').

-export([string/1,string/2,token/2,token/3,tokens/2,tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("src/Elixir.CLAWS.Lexxer.Help.xrl", 20).
...
-file("src/Elixir.CLAWS.Lexxer.Help.erl", 311).
yystate() -> 28.

yystate(29, [9|Ics], Line, Tlen, _, _) ->
    yystate(7, Ics, Line, Tlen+1, 1, Tlen);
yystate(29, [8|Ics], Line, Tlen, _, _) ->
    yystate(2, Ics, Line, Tlen+1, 1, Tlen);
yystate(29, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 7 ->
    yystate(7, Ics, Line, Tlen+1, 1, Tlen);
yystate(29, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 31 ->
    yystate(7, Ics, Line, Tlen+1, 1, Tlen);
yystate(29, [C|Ics], Line, Tlen, _, _) when C >= 33 ->
    yystate(7, Ics, Line, Tlen+1, 1, Tlen);
...
yystate(28, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 31 ->
    yystate(29, Ics, Line, Tlen+1, Action, Alen);
yystate(28, [C|Ics], Line, Tlen, Action, Alen) when C >= 33, C =< 64 ->
    yystate(29, Ics, Line, Tlen+1, Action, Alen);
yystate(28, [C|Ics], Line, Tlen, Action, Alen) when C >= 66 ->
    yystate(29, Ics, Line, Tlen+1, Action, Alen);
yystate(28, Ics, Line, Tlen, Action, Alen) ->
    {Action,Alen,Tlen,Ics,Line,28};
yystate(27, Ics, Line, Tlen, _, _) ->
    {4,Tlen,Ics,Line};
yystate(26, [87|Ics], Line, Tlen, _, _) ->
    yystate(24, Ics, Line, Tlen+1, 1, Tlen);
yystate(26, [9|Ics], Line, Tlen, _, _) ->
    yystate(7, Ics, Line, Tlen+1, 1, Tlen);
yystate(26, [8|Ics], Line, Tlen, _, _) ->
    yystate(2, Ics, Line, Tlen+1, 1, Tlen);
yystate(26, [C|Ics], Line, Tlen, _, _) when C >= 0, C =< 7 ->
    yystate(7, Ics, Line, Tlen+1, 1, Tlen);
yystate(26, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 31 ->
    yystate(7, Ics, Line, Tlen+1, 1, Tlen);
yystate(26, [C|Ics], Line, Tlen, _, _) when C >= 33, C =< 86 ->
    yystate(7, Ics, Line, Tlen+1, 1, Tlen);
yystate(26, [C|Ics], Line, Tlen, _, _) when C >= 88 ->
    yystate(7, Ics, Line, Tlen+1, 1, Tlen);
...
yystate(24, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 31 ->
    yystate(7, Ics, Line, Tlen+1, 1, Tlen);
yystate(24, [C|Ics], Line, Tlen, _, _) when C >= 33, C =< 82 ->
    yystate(7, Ics, Line, Tlen+1, 1, Tlen);
yystate(24, [C|Ics], Line, Tlen, _, _) when C >= 84 ->
    yystate(7, Ics, Line, Tlen+1, 1, Tlen);
...
yystate(22, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 31 ->
    yystate(7, Ics, Line, Tlen+1, 1, Tlen);
yystate(22, [C|Ics], Line, Tlen, _, _) when C >= 33, C =< 39 ->
    yystate(7, Ics, Line, Tlen+1, 1, Tlen);
yystate(22, [C|Ics], Line, Tlen, _, _) when C >= 41 ->
    yystate(7, Ics, Line, Tlen+1, 1, Tlen);
...
yystate(20, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 31 ->
    yystate(7, Ics, Line, Tlen+1, 1, Tlen);
yystate(20, [C|Ics], Line, Tlen, _, _) when C >= 33, C =< 40 ->
    yystate(7, Ics, Line, Tlen+1, 1, Tlen);
...
yystate(18, Ics, Line, Tlen, _, _) ->
    {1,Tlen,Ics,Line,18};
yystate(17, [87|Ics], Line, Tlen, Action, Alen) ->
    yystate(19, Ics, Line, Tlen+1, Action, Alen);
yystate(17, Ics, Line, Tlen, Action, Alen) ->
    {Action,Alen,Tlen,Ics,Line,17};
yystate(16, [65|Ics], Line, Tlen, Action, Alen) ->
...
yystate(14, [87|Ics], Line, Tlen, Action, Alen) ->
...
yystate(13, [10|Ics], Line, Tlen, _, _) ->
    yystate(13, Ics, Line+1, Tlen+1, 3, Tlen);
...
yystate(2, [C|Ics], Line, Tlen, _, _) when C >= 11, C =< 31 ->
    yystate(5, Ics, Line, Tlen+1, 1, Tlen);
yystate(2, [C|Ics], Line, Tlen, _, _) when C >= 33 ->
    yystate(5, Ics, Line, Tlen+1, 1, Tlen);
yystate(2, Ics, Line, Tlen, _, _) ->
    {1,Tlen,Ics,Line,2};
yystate(1, [8|Ics], Line, Tlen, Action, Alen) ->
...
-file("src/Elixir.CLAWS.Lexxer.Help.xrl", 11).
yyaction_0(TokenChars) ->
     { token, { bold, bold (TokenChars) } } .

-compile({inline,yyaction_1/1}).
-file("src/Elixir.CLAWS.Lexxer.Help.xrl", 12).
yyaction_1(TokenChars) ->
     { token, TokenChars } .

-compile({inline,yyaction_2/0}).
-file("src/Elixir.CLAWS.Lexxer.Help.xrl", 13).
yyaction_2() ->
     skip_token .

-compile({inline,yyaction_3/1}).
-file("src/Elixir.CLAWS.Lexxer.Help.xrl", 14).
yyaction_3(TokenChars) ->
     { token, { line_breaks, TokenChars } } .

-compile({inline,yyaction_4/0}).
-file("src/Elixir.CLAWS.Lexxer.Help.xrl", 15).
yyaction_4() ->
     skip_token .

-compile({inline,yyaction_5/1}).
-file("src/Elixir.CLAWS.Lexxer.Help.xrl", 16).
yyaction_5(TokenChars) ->
